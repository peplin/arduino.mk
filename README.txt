...
9- Xcode implementation
    ...
    select board in mpideXcode > Project mpideXcode > Info > Configurations > Release > mpideXcode
...
## To do list
    ...
    user libraries from sketchbook/libraries
    code sense
...
## © 
    ...
    based on: see References, README_peplin
